...
| CST-009 | Netlify deployment readiness | `netlify.toml` builds Next.js with the release gates and isolated public configuration; preview/production connectivity uses the same Render-only anonymous contract. | HU-018-S01..HU-018-S08 | `npm run release:check`, deploy URLs, `cors:check`, and release evidence. |
